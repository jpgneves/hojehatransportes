...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Strike.submitter'
        db.add_column('hat_strike', 'submitter', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Strike.submitter'
        db.delete_column('hat_strike', 'submitter_id')
